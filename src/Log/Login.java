...
public class Login extends javax.swing.JFrame {
    ...
    public Login() {
        ...
        String rut="D:\\Backup\\Descargas\\foto2.jpg";
        String u="admin2";
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Usuario1 u = us.IniciarSesion(usuario, pasw);

        if (u != null) {
            this.dispose();
            Usuario princ = new Usuario(u.getUser());
    ...
    System.out.println("Inicio de sesión fallido");
        ...
        try {
            ...
            while (rs.next()) {
                usu = rs.getString(1);
                pas = rs.getString(2);
                if (usuario.equals(usu) && pasw.equals(pas)) {
                JOptionPane.showMessageDialog(null, "Bienvenido");
                this.dispose();
                //Usuario user = new Usuario(usu);
